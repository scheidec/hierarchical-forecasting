...
- Prediction intervals are not yet implemented directly in `hts`
    - though it [looks possible to compute by hand](https://stats.stackexchange.com/questions/303176/building-the-covariance-matrix-for-hts-prediction-intervals)
